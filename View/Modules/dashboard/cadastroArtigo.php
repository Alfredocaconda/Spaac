<?php 
    ...
    $dados = null;
    if(isset($_GET['id_artigo_cientifico']) && is_numeric($_GET['id_artigo_cientifico'])){
        $id = $_GET['id_artigo_cientifico'];
        $sql = $conect->prepare("SELECT * FROM artigo_cientifico where id_artigo_cientifico = ?");
        $sql->bindParam(1, $id);
        $sql->execute();
...
<html lang="pt-br">
   <head>
    ...
    <!-- END LINKS EXTERNO -->
      ...
      <title>SPAAC - Cadastro de Artigo Científico  </title>
   ...
   <body class="dashboard dashboard_1">
                  ...
                  <li><a href="index.php"> <img src="images/img/home2.png" width="30"> <span>Home</span></a></li>
                     ...
                     <li>
                        ...
                        <ul class="collapse list-unstyled" id="apps">
                           ...
                           <li><a href="usuario.php"><img src="images/img/user.png" width="30"> <span>Usuário</span></a></li>
                        </ul>
                     </li>
                           ...
                           <div class="white_shd full">
                              <div class="full graph_head">
                                 <div class="heading1 margin_0">
                                    ...
                                    <img src="images/img/artigo.png" class="ImgCadUser">
    ...
    <div class="formulario">
        <form <?php if(isset($dados)){ ?> action="../../control/cadastroControllerArtigo.php?id_artigo_cientifico=<?php echo $dados['id_artigo_cientifico']; ?>" <?php } else { ?> action="../../control/cadastroControllerArtigo.php" <?php } ?> method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label for="">TÍTULO DO ARTIGO</label> <br>
                <input type="text" name="titulo" value="<?php if(isset($dados)) echo htmlspecialchars($dados['titulo']); ?>">
            </div>
            <div class="form-group">
                <label for="">RESUMO</label> <br>
                <textarea name="resumo" cols="30" rows="10"><?php if(isset($dados)) echo htmlspecialchars($dados['resumo']); ?></textarea>
            </div>
            <div class="form-group">
                <label for="">VOLUME</label> <br>
                <input type="text" name="volume" value="<?php if(isset($dados)) echo htmlspecialchars($dados['volume']); ?>">
            </div>
            <div class="form-group">
