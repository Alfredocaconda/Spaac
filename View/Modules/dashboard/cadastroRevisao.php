<?php 
    ...
    if(isset($_GET['id_revisao'])){
        $id = $_GET['id_revisao'];
        $sql = $conect->prepare("SELECT * FROM revisao where id_revisao =?");
        $sql->bindParam(1,$id);
        $sql->execute();
...
<html lang="pt-br">
   <head>
    ...
    <!-- END LINKS EXTERNO -->
      ...
      <title>SPAAC - Cadastro de Revisão </title>
   ...
   <body class="dashboard dashboard_1">
                           ...
                           <div class="white_shd full">
                              <div class="full graph_head">
                                 <div class="heading1 margin_0">
                                    ...
                                    <img src="images/img/revisao.png" class="ImgCadUser">
                                    <h2 class="titleRA">Cadastro de Revisão</h2>
                                    </div>
    ...
    <div class="formulario">
        <?php if(isset($dados)){ ?>
            <form action="../../control/cadastroControllerRevisao.php?id_revisao=<?php echo $dados['id_revisao'] ?>" method="post">
        <?php }else{ ?>
            <form action="../../control/cadastroControllerRevisao.php" method="post">
        <?php } ?>
           
            <div class="form-group">
                <label for="">Data da Revisão</label> <br>
                <input type="date" name="data_revisao" value="<?php if(isset($dados)) echo $dados['data_revisao'] ?>">
            </div>
            <div class="form-group">
                <label for="">Comentário</label> <br>
                <input type="text" name="comentario" value="<?php if(isset($dados)) echo $dados['comentario'] ?>">
            </div>
            <div class="form-group">
                <label for="">Decisão</label> <br>
                <input type="text" name="decisao" value="<?php if(isset($dados)) echo $dados['decisao'] ?>">
            </div>
