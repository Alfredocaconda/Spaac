<?php 
    ...
    $dados = null;
    if(isset($_GET['id_monografia']) && is_numeric($_GET['id_monografia'])){
        $id = $_GET['id_monografia'];
        $sql = $conect->prepare("SELECT * FROM monografia where id_monografia = ?");
        $sql->bindParam(1, $id);
        $sql->execute();
...
<html lang="pt-br">
   <head>
    ...
    <!-- END LINKS EXTERNO -->
      ...
      <title>SPAAC - Cadastro de Monografias </title>
   ...
   <body class="dashboard dashboard_1">
                           ...
                           <div class="white_shd full">
                              <div class="full graph_head">
                                 <div class="heading1 margin_0">
                                    ...
                                    <img src="images/img/monografia.png" class="ImgCadUser">
    ...
    <div class="formulario">
        <form <?php if(isset($dados)){ ?> action="../../control/cadastroControllerMonografia.php?id_monografia=<?php echo $dados['id_monografia']; ?>" <?php } else { ?> action="../../control/cadastroControllerMonografia.php" <?php } ?> method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label for="">TÍTULO DA MONOGRAFIA</label> <br>
                <input type="text" name="titulo_monografia" value="<?php if(isset($dados)) echo htmlspecialchars($dados['titulo_monografia']); ?>">
            </div>
            <div class="form-group">
                <label for="">RESUMO</label> <br>
                <textarea name="resumo_monografia" cols="30" rows="10"><?php if(isset($dados)) echo htmlspecialchars($dados['resumo_monografia']); ?></textarea>
            </div>
            <div class="form-group">
                <label for="">INSTITUIÇÃO DE ENSINO</label> <br>
                <input type="text" name="instituicao_ensino" value="<?php if(isset($dados)) echo htmlspecialchars($dados['instituicao_ensino']); ?>">
            </div>
            <div class="form-group">
                <label for="">PALAVRA CHAVE</label> <br>
                <input type="text" name="palavra_chave" value="<?php if(isset($dados)) echo htmlspecialchars($dados['palavra_chave']); ?>">
            </div>
            <div class="form-group">
                <label for="">FICHEIRO</label> <br>
                <input type="file" name="ficheiro" value="<?php if(isset($dados)) echo htmlspecialchars($dados['ficheiro']); ?>">
            </div>
            <div class="form-group">
                <label for="">DATA DA SUBMISSÃO</label> <br>
                <input type="date" name="data_submissao" value="<?php if(isset($dados)) echo htmlspecialchars($dados['data_submissao']); ?>">
            </div>
            <div class="form-group">
                <label for="">DATA DA AVALIAÇÃO</label> <br>
                <input type="date" name="data_avaliacao" value="<?php if(isset($dados)) echo htmlspecialchars($dados['data_submissao']); ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <?php 
                        if(isset($dados))
                            ...
                            echo '<img src="images/img/verificar.png" class="imgCadastar">';
                    ?>
                </button>
            </div>
        </form>
