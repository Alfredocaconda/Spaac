<?php 
    ...
    if(isset($_GET['id_categoria'])){
        ...
        $sql = $conect->prepare("SELECT * FROM categoria where id_categoria =?");
        $sql->bindParam(1,$id);
        $sql->execute();
...
<html lang="pt-br">
   <head>
    ...
    <!-- END LINKS EXTERNO -->
      ...
      <title>SPAAC - Cadastro de Categoria </title>
   ...
   <body class="dashboard dashboard_1">
                           ...
                           <div class="white_shd full">
                              <div class="full graph_head">
                                 <div class="heading1 margin_0">
                                    ...
                                    <img src="images/img/categoria.png" class="ImgCadUser">
                                    <h2 class="titleRA">Cadastro de Categoria</h2>
                                    </div>
    ...
    <div class="formulario">
        <?php if(isset($dados)){ ?>
            <form action="../../control/editarCategoria.php?id_categoria=<?php echo $dados['id_categoria'] ?>" method="post">
        <?php }else{ ?>
            <form action="../../control/cadastroControllerCategoria.php" method="post">
        <?php } ?>
           
            <div class="form-group">
                <label for="">Nome da Categoria</label> <br>
                <input type="text" name="nome_categoria" value="<?php if(isset($dados)) echo $dados['nome_categoria'] ?>">
            </div>
            <div class="form-group">
                <label for="">Tipo da Categoria</label> <br>
                <input type="text" name="tipo_categoria" value="<?php if(isset($dados)) echo $dados['tipo_categoria'] ?>">
            </div>
