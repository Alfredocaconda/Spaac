<?php 
    ...
    if(isset($_GET['id_usuario'])){
        $id = $_GET['id_usuario'];
        $sql = $conect->prepare("SELECT * FROM usuario where id_usuario =?");
        $sql->bindParam(1,$id);
        $sql->execute();
...
<html lang="pt-br">
   <head>
    ...
    <!-- END LINKS EXTERNO -->
      ...
      <title>SPAAC - Cadastro de Usuários </title>
   ...
   <body class="dashboard dashboard_1">
                           ...
                           <div class="white_shd full">
                              <div class="full graph_head">
                                 <div class="heading1 margin_0">
                                    ...
                                    <img src="images/img/cadUser2.png" class="ImgCadUser">
                                    <h2 class="titleRA">Cadastro de Usuários</h2>
                                    </div>
    ...
    <div class="formulario">
        <?php if(isset($dados)){ ?>
            <form action="../../control/editarUser.php?id_usuario=<?php echo $dados['id_usuario'] ?>" method="post">
        <?php }else{ ?>
            <form action="../../control/cadastroControllerUsuario.php" method="post">
        <?php } ?>
            <div class="form-group">
                <label for="">Nome do usuario</label> <br>
                <input type="text" name="nome_usuario" value="<?php if(isset($dados)) echo $dados['nome_usuario'] ?>">
            </div>
            <div class="form-group">
                <label for="">Tipo de usuario</label> <br>
                <input type="text" name="tipo_usuario" value="<?php if(isset($dados)) echo $dados['tipo_usuario'] ?>">
            </div>
            <div class="form-group">
                <label for="">E-mail do usuario</label> <br>
                <input type="email" name="email_usuario" value="<?php if(isset($dados)) echo $dados['email_usuario'] ?>">
            </div>
            <div class="form-group">
                <label for="">Senha do usuario</label> <br>
                <input type="password" name="senha_usuario" value="<?php if(isset($dados)) echo $dados['senha_usuario'] ?>">
            </div>
