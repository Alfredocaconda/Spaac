    ...
    <div class="Operacao">
        ...
        <div class="tabelas">
            <div style="margin-bottom:10px">
                <a href="cadastroCategoria.php" class="btncadastro">Cadastrar</a>
            </div>
            <table class="tabela">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="cadastroCategoria.php?id_categoria=<?php echo $item['id_categoria'] ?>">Editar</a>
                            <a href="../../control/apagarCategoria.php?id_categoria=<?php echo $item['id_categoria'] ?>&estado=apagar">Apagar</a>
                        </td>
                    </tr>
                    <?php 
                        }
