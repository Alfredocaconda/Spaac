<?php 
    ...
    $user = $conect->query("select * from usuario");
    $dados = $user->fetchAll();
?>
...
<html lang="pt-br">
   <head>
    ...
    <!-- END LINKS EXTERNO -->
      ...
      <title>SPAAC - Lista de Usuários </title>
      ...
      <div class="full_container">
                           ...
                           <div class="white_shd full">
                              <div class="full graph_head">
                                 <div class="heading1 margin_0">
                                    ...
                                    <h2 class="titleRA">Lista de Usuários</h2>
                                    </div>
                                 </div>
                              </div>
        ...
        <div class="tabelas">
            <div class="form-group">
               <form action="">
                  <input type="search" name="" value="" placeholder="Faça sua pesquisa">
                  <button type="submit" class="btnPesquisarUser"> Buscar </button>
                ...
                <tbody>
                    ...
                    <tr class="trDados">
                        ...
                        <td>
                              ...
                              <a class="ActionEditar" href="cadastroUsuario.php?id_usuario=<?php echo $item['id_usuario'] ?>"><img src="images/img/editar.png" width="20"></a>
                        
                              <a class="ActionExcluir" href="../../control/apagarUsuario.php?id_usuario=<?php echo $item['id_usuario'] ?>&estado=apagar"><img src="images/img/delete.png" width="20"></a>
