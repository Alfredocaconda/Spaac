            ...
            <div class="center verticle_center full_height">
               <div class="login_section">
                  ...
                  <div class="login_form">
                     <form action="../../control/login.php" method="Post" enctype="multipart/form-data" >
                        <fieldset>
                           <div class="field">
                           ...
                           <div class="field">
                              ...
                              <label class="form-check-label"><input type="checkbox" class="form-check-input">Lembrar senha</label>
                              <a class="forgot" href="">Esqueceste a palavra-passe?</a>
                           </div>
