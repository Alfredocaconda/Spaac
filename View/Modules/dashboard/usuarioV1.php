    ...
    <div class="main_menu">
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container box_1620">
          ...
          <a class="navbar-brand logo_h" href="index.html"><img src="../principal/img/logoSpaac.png" alt="" class="LogoSpaac"></a>
    ...
    <div class="Operacao">
        ...
        <div class="tabelas">
            <div style="margin-bottom:10px">
                <a href="cadastroUsuario.php" class="btncadastro">Cadastrar</a>
            </div>
            <table class="tabela">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="cadastroUsuario.php?id_usuario=<?php echo $item['id_usuario'] ?>">Editar</a>
                            <a href="../../control/apagarUsuario.php?id_usuario=<?php echo $item['id_usuario'] ?>&estado=apagar">Apagar</a>
                        </td>
                    </tr>
                    <?php 
                        }
