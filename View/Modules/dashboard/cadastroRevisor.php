<?php 
    ...
    if(isset($_GET['id_revisor'])){
        $id = $_GET['id_revisor'];
        $sql = $conect->prepare("SELECT * FROM revisor where id_revisor =?");
        $sql->bindParam(1,$id);
        $sql->execute();
...
<html lang="pt-br">
   <head>
    ...
    <!-- END LINKS EXTERNO -->
      ...
      <title>SPAAC - Cadastro de Revisor </title>
   ...
   <body class="dashboard dashboard_1">
                           ...
                           <div class="white_shd full">
                              <div class="full graph_head">
                                 <div class="heading1 margin_0">
                                    ...
                                    <img src="images/img/revisor.png" class="ImgCadUser">
    ...
    <div class="formulario">
        <?php if(isset($dados)){ ?>
            <form action="../../control/cadastroControllerRevisor.php?id_revisor=<?php echo $dados['id_revisor'] ?>" method="post">
        <?php }else{ ?>
            <form action="../../control/cadastroControllerRevisor.php" method="post">
        <?php } ?>
           
            <div class="form-group">
                <label for="">Nome do Revisor</label> <br>
                <input type="text" name="nome_revisor" value="<?php if(isset($dados)) echo $dados['nome_revisor'] ?>">
            </div>
            <div class="form-group">
                <label for="">Instituição do Revisor</label> <br>
                <input type="text" name="instituicao_revisor" value="<?php if(isset($dados)) echo $dados['instituicao_revisor'] ?>">
            </div>
            <div class="form-group">
                <label for="">Email do Usuario</label> <br>
                <input type="text" name="email_revisor" value="<?php if(isset($dados)) echo $dados['email_revisor'] ?>">
            </div>
