<?php 
    ...
    $categoria = $conect->query("select * from categoria");
                           ...
                           <div class="white_shd full">
                              <div class="full graph_head">
                                 <div class="heading1 margin_0">
                                    ...
                                    <h2 class="titleRA">Lista de Categoria</h2>
                                    </div>
                                 </div>
                              </div>
            ...
            <table class="tabela">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $item['tipo_categoria'] ?></td>
                        <td>
                            <a class="ActionEditar" href="cadastroCategoria.php?id_categoria=<?php echo $item['id_categoria'] ?>"><img src="images/img/editar.png" width="20"></a>
                            <a class="ActionExcluir" href="../../control/apagarCategoria.php?id_categoria=<?php echo $item['id_categoria'] ?>&estado=apagar"><img src="images/img/delete.png" width="20"></a>
                        </td>
                    </tr>
                    <?php 
                        }
