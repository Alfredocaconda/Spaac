...
<html lang="pt-br">
   <head>
    ...
    <!-- END LINKS EXTERNO -->
      ...
      <title>SPAAC - Cadastro de Autores </title>
                           ...
                           <div class="white_shd full">
                              <div class="full graph_head">
                                 <div class="heading1 margin_0">
                                    ...
                                    <h2 class="titleRA">Cadastro de Autores</h2>
                                    </div>
    ...
    <div class="formulario">
        ...
        <?php } ?>
            ...
            <div class="form-group">
                ...
                <input type="text" name="telefone" maxlength=9 placeholder="(+244) xxx-xxx-xxx" value="<?php if(isset($dados)) echo $dados['telefone'] ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="grau_academico" placeholder="Ex: Licenciatura" value="<?php if(isset($dados)) echo $dados['grau_academico'] ?>">
            </div>
    
            <div class="form-group">
                <button class="btnCadAutor">
                    <?php 
                        if(isset($dados))
                            echo "Actualizar";
                        else
