<?php 
    ...
    $autor = $conect->query("select * from revisao");
                           ...
                           <div class="white_shd full">
                              <div class="full graph_head">
                                 <div class="heading1 margin_0">
                                    ...
                                    <h2 class="titleRA">Lista de Revisões</h2>
                                    </div>
                                 </div>
                              </div>
        ...
        <div class="tabelas">
            ...
            <table class="tabela">
                ...
                <tbody>
                    ...
                    ?>
                    <tr>
                        <td><?php echo $item['id_revisao'] ?></td>
                        <td><?php echo $item['data_revisao'] ?></td>
                        <td><?php echo $item['comentario'] ?></td>
                        <td><?php echo $item['decisao'] ?></td>
			            <td><?php echo $item['id_revisor'] ?></td>
			            <td><?php echo $item['id_monografia'] ?></td>
			            <td><?php echo $item['id_artigo_cientif'] ?></td>
                        <td>
                            <a href="cadastroRevisao.php?id_revisao=<?php echo $item['id_revisao'] ?>">Editar</a>
                            <a href="../../control/apagarRevisao.php?id_revisao=<?php echo $item['id_revisao'] ?>&estado=apagar">Apagar</a>
                        </td>
                    </tr>
                    <?php 
                        }
