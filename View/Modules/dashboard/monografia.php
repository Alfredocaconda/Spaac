<?php 
    ...
    $user = $conect->query("select * from monografia");
    $dados = $user->fetchAll();
?>
<html lang="pt-br">
   <head>
                           ...
                           <div class="white_shd full">
                              <div class="full graph_head">
                                 <div class="heading1 margin_0">
                                    ...
                                    <h2 class="titleRA">Lista de Monografias</h2>
                                    </div>
                                 </div>
                              </div>
        ...
        <div class="tabelas">
            ...
            <table class="tabela">
                ...
                <tbody>
                    ...
                    ?>
                    <tr>
                        <td><?php echo $item['id_monografia'] ?></td>
                        <td><?php echo $item['titulo_monografia'] ?></td>
                        <td><?php echo $item['resumo_monografia'] ?></td>
                        <td><?php echo $item['instituicao_ensino'] ?></td>
                        ...
                        <td>
                            <a href="cadastroMonografia.php?id_monografia=<?php echo $item['id_monografia'] ?>">Editar</a>
                            <a href="../../Control/apagarMonografia.php?id_monografia=<?php echo $item['id_monografia'] ?>&estado=apagar">Apagar</a>
                        </td>
                    </tr>
                    <?php 
                        }
