...
<html lang="PT">
   ...
   <body class="dashboard dashboard_1">
                     ...
                     <div class="row column_title">
                        <div class="col-md-12">
                           <div class="page_title">
                              <h2>Lista de todos Categoria cadastrados</h2>
                           </div>
                        </div>
                     </div>
    <table class="table table-hover">
        ...
        <tr>
            <td scope="col"><?=$item->id_categoria ?></td>
            <td scope="col"><?=$item->nome_categoria?> </td>
            <td scope="col"><?=$item->tipo_categoria?> </td>
            <td width=10px;> <a href="/categoria/delete?idcategoria=<?=$item->id_categoria?>" class="btn btn-danger">
            APAGAR</a></td>
            <td> <a href="/categoria/form?idcategoria=<?=$item->id_categoria?>"
            class="btn btn-success">EDITAR</a></td>
        </tr>
        <?php endforeach ?> 
    </table>
    </div>
    <a href="/categoria/form" class="btn btn-primary" id="btnVerRegisto"><img src="../images/img/cadastro.png" width="30">Add novo</a>
                  <!-- footer -->
                  <div class="container-fluid">
                     <div class="footer">
