...
<html lang="en">
   ...
   <body class="dashboard dashboard_1">
                  ...
                  <div class="container-fluid">
                     <div class="row column_title">
                        <div class="col-md-12">
                              ...
                              <img src="../images/img/categoria.png" class="ImgCadUser" width="60">
    ...
    <form action="/categoria/form/save" method="Post" enctype="multipart/form-data" class="row g-3">
        <input type="hidden" name="id_categoria"  value="<?= $model->id_categoria ?>" >
        <div class="col-md-6">
        <label for="inputEmail4" class="form-label">TIPO</label>
        <input type="text" class="form-control" name="nome_categoria" value="<?= $model->nome_categoria ?>" id="inputEmail4" 
        placeholder="DIGITE AQUI O TIPO" required>
        </div>
        <div class="col-md-6">
        <label for="inputEmail4" class="form-label">NOME</label>
        <input type="text" class="form-control" name="tipo_categoria" value="<?= $model->tipo_categoria ?>" id="inputEmail4" 
        placeholder="DIGITE AQUI O NOME" required>
        </div>
        <div class="col-12">
        ...
        <a href="/categoria" class="btn btn-primary" id="btnVerRegisto"><img src="../images/img/ver.png" width="30">Ver os registos</a>
