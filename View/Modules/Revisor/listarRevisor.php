                     ...
                     <div class="row column_title">
                        <div class="col-md-12">
                           <div class="page_title">
                              <h2>Listar os Dados da Formação</h2>
                           </div>
                        </div>
                     </div>
   ...
   <div class="row">
    ...
    <table class="table table-hover">
        ...
        <?php foreach ($model->linhas as $item): ?>
            <td scope="col" ><?=$item->nome_revisor?> </td>
            <td scope="col"><?=$item->instituicao_revisor?> </td>
            <td scope="col"><?=$item->email_revisor?> </td>
            <td scope="col"><?=$item->id_usuario?> </td>
            <td scope="col"> <a href="/Revisor/delete?id_revisor=<?=$item->id_revisor?>" class="btn btn-danger">APAGAR</a></td>
            <td scope="col"> <a href="/Revisor/form?id_revisor=<?=$item->id_revisor?>" class="btn btn-success">EDITAR</a></td>
        </tr>
        <?php endforeach ?> 
    </table>
    </div>
    </div>
    <a href="/Revisor/form" class="btn btn-primary" id="btnVerRegisto"><img src="../images/img/cadastro.png" width="30">Add novo</a>
<!-- /.content-wrapper -->
